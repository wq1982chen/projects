...
public class RemoteMQ{
     ...
     static{
    	 ...
    	 MQEnvironment.hostname="172.16.70.31";         	//MQ服务器的IP地址    
    	 MQEnvironment.channel="SVRCONN";  			//服务器连接的通道
    	 MQEnvironment.CCSID=1381;              		//服务器MQ服务使用的编码1381代表GBK、1208代表UTF(Coded Character Set Identifier:CCSID)
    	 MQEnvironment.port=1515;						//MQ端口
    	 qmName = "QM2";							//MQ的队列管理器名称
         qName = "QL";								//MQ远程队列的名称
         try {
        	 //定义并初始化队列管理器对象并连接 
     ...
     public static String getMessage(){
    	 ...
    	 try{    		 
    		 ...
    		 gmo.options = gmo.options + MQConstants.MQGMO_FAIL_IF_QUIESCING;// Fail if Qeue Manager Quiescing（如果队列管理器停顿则失败） 
